package com.vanguard.limiter.aspect;

import com.vanguard.common.ModelConstants;
import com.vanguard.limiter.annotation.RateLimited;
import com.vanguard.limiter.service.RateLimiterService;
...
public class RateLimitAspect {
    ...
    public Object enforceRateLimit(ProceedingJoinPoint joinPoint, RateLimited rateLimited) throws Throwable {
        ...
        String redisKey = ModelConstants.REDIS_RATE_LIMIT_PREFIX + userId;
